<template>
  <article
    @mouseenter="activeOrder = true"
    @mouseleave="activeOrder = false"
    class="relative w-full border border-indigo-100 bg-indigo-100 rounded p-2"
  >
    ...
    <div @click="$emit('updateOrder', history.id)" v-show="activeOrder" class="h-4 w-4 absolute top-2 right-2 cursor-pointer">
      <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	 viewBox="0 0 386.615 386.615" style="enable-background:new 0 0 386.615 386.615;" xml:space="preserve">
        <g>
          <g>
            <g>
